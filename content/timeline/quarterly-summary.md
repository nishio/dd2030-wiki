...
- **3/16**: [[entities/kouchou-ai|広聴AI]]と[[entities/idobata|いどばた]]のGitHubリポジトリ公開
- **4/12**: 第1回ミートアップ開催。「AIと対話してGitHubにPRを送る」プロトタイプが「革命的」と評価される
- **4月中旬**: [[entities/polimoney|Polimoney]]が本格始動。公開第一号ユーザーが登場
- dd2030.orgサイトのリニューアル（Devin支援）
- [[entities/idobata|いどばた]]で「ユーザー体験検討会」開催（ダブルダイヤモンドプロセス）
...
- **5月**: [[entities/kouchou-ai|広聴AI]] v3.0.0リリース
- **5月下旬**: アンカンファレンス形式のオフラインミートアップ（MEETUP #2）
- **6月**: 「Plurality」読書会（#7_広聴ai読書会）開始
- **6月**: [[entities/kouchou-ai|広聴AI]]の技術解説スライドが「神資料」と評判
- **7/18**: MEETUP #3開催
- 宇多津町（香川）で[[entities/kouchou-ai|広聴AI]]の実証が公開
...
- **8月**: 広島県で[[entities/kouchou-ai|広聴AI]]市民向け活用事例が公開・拡散
- **8月**: [[entities/polimoney|Polimoney]]ブランド名をコミュニティ投票で決定
- **8月**: [[entities/idobata|いどばた]]ビジョンにセーシェル共和国NPOが関心
- **9月**: LGWAN環境対応の議論（自治体イントラ導入の壁）
- **10月**: [[entities/broad-listening-book|ブロードリスニング本]]の出版決定。執筆開始
...
- **11月**: バルセロナDecidimコミュニティから[[entities/kouchou-ai|広聴AI]]への国際的関心
- **11月**: farbrain（ブレスト支援ツール）、DivCon（対立軸可視化）等の新ツール試作
- **11月**: 「ゲートウェイデモクラシー」概念が登場
- **12月**: [[entities/broad-listening-book|ブロードリスニング本]]をAI活用で爆速執筆（1日1万字超）
- **12月**: [[entities/polimoney|Polimoney]]がテレビ番組で紹介決定
- **12月**: 朝日新聞の取材決定
...
- **1月**: [[entities/coreloop|コアループ]]（Project Coreloop）キックオフ — 詐欺広告対策の市民熟議
- **1月**: [[entities/kouchou-ai|広聴AI]] v5.0へのリファクタリング開始（プラグイン方式・PyPI化）
...
- **3月**: [[entities/broad-listening-book|ブロードリスニング本]]が校正段階に（30万文字超）
...
- [[entities/kouchou-ai|広聴AI]] / [[entities/idobata|いどばた]] / [[entities/polimoney|Polimoney]] — 3つの柱
- [[entities/coreloop|コアループ]] — 最新の重点プロジェクト
