...
**Project Coreloop**は、日本においてAIを活用したデジタル民主主義の「最初の成功事例」を作ることを目的とするdd2030の重点プロジェクト。単なる[[concepts/broad-listening|ブロードリスニング]]によるインサイト取得にとどまらず、**市民の声が政策に反映・実行され、市民満足度向上につながるという「コアループ全体の成功」**を目指す。
...
- **1/12**: プロジェクトキックオフ
- **1/15-16**: **台湾視察ツアー**。頼清徳総統・蔡英文前総統との意見交換。10件のヒアリング
...
- **台湾**: 頼清徳総統・蔡英文前総統との意見交換。MODA（デジタル省）等10件のヒアリング
